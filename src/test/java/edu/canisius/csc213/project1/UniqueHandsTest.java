...
public class UniqueHandsTest {
    ...
    public void testCountAttemptsToSeeAllHandsIncreasesWithDeckSize() {
        int attempts24 = UniqueHands.countAttemptsToSeeAllHands(24, 6, 0);
        int attempts28 = UniqueHands.countAttemptsToSeeAllHands(28, 6, 0 );
    ...
    public void testCountAttemptsToSeeAllHandsIncreasesWithHandSize() {
        int attempts6 = UniqueHands.countAttemptsToSeeAllHands(24, 6, 0 );
        int attempts7 = UniqueHands.countAttemptsToSeeAllHands(24, 7, 0);
